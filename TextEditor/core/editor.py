...
from core.custom_notebook import CustomNotebook, TextTab
...
class Editor(Tk):
    ...
    def surface(self):
        ...
        # control the notebook by passing "nb_obj"
        self.main_menu = MainMenu(nb_obj = self.custom_notebook)
        self.config(menu = self.main_menu)

        # When starting to run, create a new tab
        self.main_menu.menu_opt_cmd.new()
