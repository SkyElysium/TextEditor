...
class MainMenu(tk.Menu):
    ...
    def main_menu_config(self):
        ...
        self.file_opt.add_separator()
        self.file_opt.add_command(label = 'Close', accelerator = 'Ctrl+F4', command = self.menu_opt_cmd.close)
...
class MenuOptCmd:
    ...
    def save_as(self, event = None):
        ...
        self.nb_obj.update_info_on_title()
