...
class CustomNotebook(ttk.Notebook):
    ...
    def update_info_on_title(self, event = None): # Be binded, so None
...
class TextTab(tk.Frame):
    ...
    def place_widgets(self):
        self.text = tk.Text(self, wrap = 'none', undo = True, bd = False, font = ('Consolas', 13))
    ...
    def paste(self, event = None):
        ...
        # The clipboard shouldn't be empty
